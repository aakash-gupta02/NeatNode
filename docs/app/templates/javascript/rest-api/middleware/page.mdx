...
The **REST API Template** groups all middleware under `src/middleware/` (in MVC) or `src/core/middleware/` (in Modular) for clear organization and reusability.  
...
```javascript
import express from "express"
// Adjust relative path depending on MVC vs Modular structure:
// MVC:
...
// Modular:
// import { auth } from "../../core/middleware/auth.middleware.js"
