...
const Terminal = () => {
  ...
  const steps = {
    js: [
      { icon: "✔", text: "Select language:", highlight: "JavaScript" },
      { icon: "✔", text: "Choose template:", highlight: "REST API" },
      { icon: "✔", text: "Select architecture:", highlight: "MVC / Modular" },
      { icon: "✔", text: "Include example CRUD:", highlight: "Yes / No" },
    ],

    ts: [
      { icon: "✔", text: "Select language:", highlight: "TypeScript" },
      { icon: "✔", text: "Choose template:", highlight: "REST API" },
      { icon: "✔", text: "Include example CRUD:", highlight: "Yes / No" },
    ],
  };
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-zinc-300">
                npx neatnode {language === "js" ? "my-app" : "my-app-ts"}
              </span>
            </div>
            ...
            <div className="space-y-1 ml-4">
              {steps[language].map((step, index) => (
                <div key={index} className="flex items-center space-x-2">
                  ...
                  <span className="text-zinc-500">
                    {step.text}{" "}
                    <span className="text-zinc-300">{step.highlight}</span>
                  </span>
                </div>
              ))}
              ...
              <div className="mt-2 text-zinc-400">
                cd {language === "js" ? "my-app" : "my-app-ts"} && npm install
                && npm run dev
              </div>
            </div>
          </div>
